...
<link rel="stylesheet" href="http://localhost/brief5-nv/mvc/view/css/main.css">
  ...
  <div id="salleForm">
        <p>
            <form action="http://localhost/brief5-nv/mvc/salle/create" method ="Post">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <input type="button"  class="btn btn-dark" value="Ajouter une ligne" name="ajouterrow" onclick="addrow()">
                </div>
        ...
        <table class="table table-hover" id="table">
            ...
            <?php
                    $i=0;
                        ...
                        <form action="http://localhost/brief5-nv/mvc/salle/update" method="POST">
                            <tr>
                                ...
                                <td>
                                    <label id="capaciteLabel<?=$i?>" for=""><?php echo $res['capacite'] ?></label>
                                    <input type="number" id="capacite<?=$i?>" value="<?php echo $res['capacite'] ?>" name="capacite" style="display:none" >
                                </td>
                                <td style="display: flex;">
                                    ...
                                    <form action="http://localhost/brief5-nv/mvc/salle/delete" method="post">
