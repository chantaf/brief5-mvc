...
<body>
  ...
  <div class="wrapper">
      ...
      <form action="http://localhost/brief5-nv/mvc/login/create" method="post" class="form-right">
          <h2 class="text-uppercase"> inscrivez Vous</h2>
          <div class="row">
          </div>
          <div class=" col-sm-6 "> <label>votre nom</label> <input type="name" class="input-field" name="name" required > </div>
          <div class=" col-sm-6 "> <label>votre email</label> <input type="email" class="input-field" name="email" required > </div>
          <div class=" col-sm-6 ">
             <label>votre matiere</label>
             <select class="selectionM" name="id_matiere">
        ...
        <div  class="form-field">
          ...
          <div  class="button11">
          <button name="submit" class="btn btn-info btn-lg ">inscrivez </button> 
          </form>
          <form action="http://localhost/brief5-nv/mvc/login/" method="POST">
