...
<link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-T8Gy5hrqNKT+hzMclPo118YTQO6cYprQmhrYwIiQ/3axmI1hQomh7Ud2hPOy8SP1" crossorigin="anonymous">
            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li><a href="http://localhost/brief5-nv/mvc/matiere/"><i class="fa fa-book" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Matiere</span></a></li>
                        <li class="active"><a href=""><i class="fa fa-group" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Groupe</span></a></li>
                        <li><a href="#"></a></li>
                        <li><a href="#"></a></li>
                        <li><a href="#"></a></li>
                        <li><a href="#"></a></li>
  ...
  <div id="salleForm">
        <p>
            <form action="http://localhost/brief5-nv/mvc/groupe/create" method ="Post">
                
                <div id="inputs">

                    <div class="col-xs-6">
                        <label for="ex3">libelle</label>
                        <input class="form-control" id="ex3" type="text" name="libellee">
                    </div>

                    <div class="col-xs-6">
                        <label for="ex3">effectif</label>
                        <input class="form-control" id="ex3" type="number" name="effectif">
                    </div>

                </div>

                <div class="col-md-12 text-center">
                    <input type="submit" class="btn btn-dark" id="buttonadd" value="Ajouter" name="ajouter">
                </div>
...
<!--------------------- table ---------------------->
        ...
        <table class="table table-hover" >
            ...
            <?php
                    ...
                    $i=0;
                        ...
                        <form action="http://localhost/brief5-nv/mvc/groupe/update" method="POST">
                            <tr>
                                <td><label  for=""><?php echo $res['id'] ?></label><input type="hidden" value="<?php echo $res['id'] ?>" name="id" ></td>
                                <td>
                                    <label id="libellelabel<?=$i?>" for=""><?php echo $res['libellee'] ?></label>
                                    <input type="text" id="libellee<?=$i?>" value="<?php echo $res['libellee'] ?>" name="libellee" style="display:none" >
                                </td>
                                <td>
                                    <label id="effectifLabel<?=$i?>" for=""><?php echo $res['effectif'] ?></label>
                                    <input type="number" id="effectif<?=$i?>" value="<?php echo $res['effectif'] ?>" name="effectif" style="display:none" >
                                </td>
                                <td style="display: flex;">
                                    ...
                                    <form action="http://localhost/brief5-nv/mvc/groupe/delete"  method="post">
    ...
    <script>
        ...
        function modifie(e){
            ...
            document.getElementById('libellee'+e).style.display="block";
            document.getElementById('effectifLabel'+e).style.display="none";
            document.getElementById('effectif'+e).style.display="block";
        ...
        function cancel(e)
        {
            ...
            document.getElementById('libellee'+e).style.display="none";
